package com.xxy.xxypicturebackend.manager.sharding;
...
public class DynamicShardingManager {
    ...
    private static final String DATABASE_NAME = "xxy_picture"; // 配置文件中的数据库名称
    ...
    private void updateShardingTableNodes() {
        ...
        String newActualDataNodes = tableNames.stream()
                .map(tableName -> "xxy_picture." + tableName) // 确保前缀合法
